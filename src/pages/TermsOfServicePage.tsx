    ...
    <div className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        <p className="mb-10 font-sans text-sm leading-relaxed text-[#5A5A5A] sm:text-base">
          ...
          products and services operated by{' '}
          <span className="font-medium text-[#1A1A1A]">Intrct Technologies</span> under the Missout
          brand, including Stage for event discovery and the Backstage event-management suite.
          Please read them carefully. By creating an account or using any part of the platform, you
          agree to be bound by these Terms. If you do not agree, do not use Missout.
        </p>

        <Section title="1. Eligibility">
          <p>
            You must be at least 16 years old to use Missout. We do not verify your age at
            registration. By creating an account or using the platform you represent and warrant
        ...
        <Section title="4. Event Listings & Organiser Responsibilities">
          ...
          <p>
            Missout operates Stage for discovery and Backstage for event management only. We are not a party to any
        ...
        <Section title="10. Termination">
          ...
          <p>
            Upon termination, Sections 5, 6, 7, 8, and 12 survive.
          </p>
        </Section>
